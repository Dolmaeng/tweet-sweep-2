...
- [x] T36 `rush` 폭주 프리셋(2초·u 0.95·워밍업/긴 휴식 없음, ADR-0011) + 실시간 기록에 본문 표시(FR-11a) — 라이브 검증 대기: 429 발생 시점·창 리셋 주기·잠금 여부 — AC: 예산 분산 산식을 건너뛰고 2초로 달림, 기존 프리셋의 실질 최저 간격 불변, 설정 화면에 위험·총량 배너
