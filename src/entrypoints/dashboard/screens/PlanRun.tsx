  ...
  return (
    <section className="card">
      ...
      <div className="notice">
        <b>아카이브 모드</b>입니다. 가져온 zip의 목록대로 글 하나하나의 주소로 찾아가 지웁니다 —
        프로필 타임라인을 훑지 않으므로 <b>타임라인에 더 안 내려오는 오래된 글도 지웁니다.</b> 다만
        아카이브에 없는 정보(내가 좋아요·북마크한 글 여부, 아카이브 생성 이후에 쓴 글)로는 거를 수
        없습니다. 그 조건이 필요하면 홈의 <b>아카이브 없이 삭제</b>를 쓰세요.
      </div>
      {posts === null ? (
